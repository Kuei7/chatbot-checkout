...
export const conversationScript: ScriptItem[] = [
  ...
  { type: 'bot', contentType: 'text', content: 'Só que isso mudou depois que descobri esse método da IA. E, justamente por ter passado por isso, eu não vou cobrar R$ 500 pra te mostrar.', delay: 3000 },
