  ...
  return (
    <header className="user-bar">
      ...
      <div className="avatar">
        <Image src="https://s3.typebot.io/public/workspaces/cme0in7zf0022jo04wbcry6pa/typebots/vmq15sy6m7awugtgcsxl42dq/blocks/m831s3k25cccnbrbfe1qk9v4?v=1751522741299" alt="Avatar" width={40} height={40} data-ai-hint="man portrait"/>
      </div>
      <div className="name-status">
        <div className="name">
          <span>Zé do Black</span>
